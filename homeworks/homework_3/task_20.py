...
# alphabet_rus = {'А': 1, 'Б': 3, 'В': 1, 'Г': 3, 'Д': 2, 'Е': 1, 'Ё': 3, 'Ж': 5, 'З': 5, 'И': 1, 'Й': 4, 'К': 2, 'Л': 2, 'М': 2, 'Н': 1, 'О': 1, 'П': 2, 'Р': 1, 'С': 1, 'Т': 1, 'У': 2, 'Ф': 10, 'Х': 5, 'Ц': 5, 'Ч': 5, 'Ш': 8, 'Щ': 10, 'Ъ': 10, 'Ы': 4, 'Ь': 3, 'Э': 8, 'Ю': 8, 'Я': 3}

# word = input("Введите слово: ").upper()
# score = 0

# if all(symbols in alphabet_eng for symbols in word): # проверяем, что все символы английские
#     for symbols in word:
#         score += alphabet_eng[symbols]
# elif all(symbols in alphabet_rus for symbols in word): # проверяем, что все символы русские
#     for symbols in word:
#         score += alphabet_rus[symbols]
# else:
#     print("Ошибка! В слове должны быть только английские или только русские буквы.")
#     score = None # в случае ошибки сбрасываем значение score

# if score is not None: # если нет ошибок, выводим результат
#     print("Строимость слова:", score)
